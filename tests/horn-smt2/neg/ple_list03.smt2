...
(define filter ((lq1 (func 0 ((obj a##a29r)) bool))  (lq2 ([]  (obj a##a29r)))) ([]  (obj a##a29r)) (if  (isNil  lq2)  Nil  (if  (lq1  (head  lq2))  ((Cons  (head  lq2))  ((filter  lq1)  (tail  lq2)))  ((filter  lq1)  (tail  lq2)))))
