...
unitTests
  = group "Unit" [
    ...
    , testGroup "horn-json-pos-na" <$> dirJsonTests nativeCmd "tests/horn/pos/.liquid"  []          ExitSuccess
    , testGroup "horn-json-neg-na" <$> dirJsonTests nativeCmd "tests/horn/neg/.liquid"  []          (ExitFailure 1)
